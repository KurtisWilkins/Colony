/*
 * IRRIGATION CONTROLLER — COLONY-MAIN
 * Olimex ESP32-S2-DevKit-Lipo Firmware v1.0.0
 * 16-Zone SainSmart Relay Module Controller
 *
 * Board: ESP32-S2 Dev Module (or Olimex ESP32-S2)
 * USB CDC On Boot: Enabled
 * Upload: No BOOT button needed (native USB)
 * Libraries: PubSubClient, ArduinoJson v6
 */

// ESP32-S2: Serial via native USB CDC
#include <Arduino.h>
#include <WiFi.h>
...
// ============================================================================
// PSRAM-aware buffer allocation (ESP32-S2 utility)
// ============================================================================
...
void setup() {
    ...
    // accidental valve activation during ESP32-S2 GPIO initialization.
    // ========================================================================
    ...
    Serial.println(" Colony Platform - Olimex ESP32-S2-DevKit-Lipo");
    Serial.println(" 16-Zone Relay Board (ACTIVE LOW)");
    Serial.println(" Native USB CDC — No COM driver required");
    Serial.println("=========================================");
