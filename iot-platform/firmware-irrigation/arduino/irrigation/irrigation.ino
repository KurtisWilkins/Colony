 ...
 *
 * HARDWARE:
 * SainSmart 16-channel relay module (ACTIVE LOW)
 * 16x 12V DC solenoid valves
 *
 * TEST MODE: Boots in TEST MODE by default.
 * No relays will be physically activated.
 * Disable via MQTT: set_test_mode { "enabled": false }
 *
 * UPLOAD: Hold BOOT when you see "Connecting......"
 * Release when upload percentage appears.
 */
