...
<h1>&gt; Irrigation Setup_</h1>
<p class="subtitle">16-Zone Irrigation Controller — Colony Platform</p>
...
<p class="version">Irrigation Controller v1.0.0 — Colony Platform</p>
...
document.getElementById('configForm').addEventListener('submit',function(e){
  ...
  fetch('/save',{method:'POST',body:new URLSearchParams(formData)})
    .then(function(r){
      if(r.ok){
        status.textContent='Irrigation controller configured. Rebooting...';
